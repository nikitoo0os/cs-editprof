    ...
    public static string Error(string? code)
    {
        ...
        return code switch
        {
            ...
            "DEMO_NETWORK_VERSION_INCOMPATIBLE" =>
                "Эта демка записана версией CS2, которую установленная игра уже не может воспроизвести. Обновите CS2; если он уже обновлён, нужна демка от совместимой версии игры.",
